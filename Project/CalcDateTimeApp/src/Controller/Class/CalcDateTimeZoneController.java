...
public class CalcDateTimeZoneController implements InterfCalcDateTimeZoneController {
    ...
    private void flowDiffInTimeZones() {
        List<String> zoneIdsTxt = flowShowAllAvailableTimezonesAndGetNZoneIds(2, viewZoneTxt.getMenu(4), model.getZoneZone());
    ...
    private void flowShowCurrentTimeInZone() {
        String answerZone = flowShowAllAvailableTimezonesAndGetNZoneIds(1, viewZoneTxt.getMenu(4), model.getZoneZone()).get(0);
