...
public class MySlotComparator implements Comparator<Slot> {
    ...
    public int compare(Slot s1, Slot s2) {
        ...
        else if(data1.getClass().getSimpleName().equals("ZonedDateTime")){
                if(data2.getClass().getSimpleName().equals("ZonedDateTime")){
                    System.out.println("AS DUAS DATAS SÃO LOCALDATETIME");
                    ZonedDateTime ldt1 = ZonedDateTime.from(data1);
                    ZonedDateTime ldt2 = ZonedDateTime.from(data2);
                            ...
                            if(ldt1.getMonth()==ldt2.getMonth()){
                                ...
                                if(ldt1.getDayOfMonth()== ldt2.getDayOfMonth()) {
                                    ...
                                    if (ldt1.isBefore(ldt2)) {
                                        ...
                                        ZonedDateTime data1Final = ldt1.plus(d1);
                                        ...
                                        ZonedDateTime data2Final= ldt2.plus(d2);
        ...
        System.out.println("Se estou aqui é porque não são ZonedDateTime");
        return 0;
